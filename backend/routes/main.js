...
router.get(
  ...
  mountainCtrl.getUserMountain
);
router.post(
  "/users/:userid/mnts",
  mountainCtrl.addUserMountain
);
router.put(
  "/users/:userid/mnts/:mntid/img",
  upload,
  mountainCtrl.addUserMountainImage
);
router.put(
  "/users/:userid/mnts/:mntid",
  mountainCtrl.updateUserMountain
);
router.delete(
  "/users/:userid/mnts/:mntid",
  mountainCtrl.deleteUserMountain
);
